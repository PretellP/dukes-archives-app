                        ...
                        <div class="widget-category-list mt-20">
                            <form action="#">
                                <div class="single-widget-category">
                                    ...
                                    <label for="cat-item-1">Ciencia &amp; Ficción <span>(12)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-2" name="cat-item">
                                    <label for="cat-item-2"> Aventura <span>(60)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-3" name="cat-item">
                                    <label for="cat-item-3">Suspenso &amp; Misterio <span>(41)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-4" name="cat-item">
                                    <label for="cat-item-4">Autoayuda <span>(28)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-5" name="cat-item">
                                    <label for="cat-item-5">Comedia <span>(21)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-7" name="cat-item">
                                    <label for="cat-item-7">Romance <span>(62)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-8" name="cat-item">
                                    <label for="cat-item-8">Infantil &amp; Juvenil <span>(22)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-9" name="cat-item">
                                    <label for="cat-item-9">Historietas &amp; Mangas <span>(20)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-10" name="cat-item">
                                    <label for="cat-item-10">Política &amp; Sociedad <span>(06)</span></label>
                                </div>
                                <div class="single-widget-category">
                                    <input type="checkbox" id="cat-item-11" name="cat-item">
                                    <label for="cat-item-4"> Desarrollo Personal <span>(28)</span></label>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="product__sm mt-20">
                            <ul>
                                <li class="product__sm-item d-flex align-items-center">
                                    <div class="product__sm-thumb mr-20">
                                        <a href="{{ route ('home.product-details.index')}}">
                                            <img src="https://www.crisol.com.pe/media/catalog/product/cache/cf84e6047db2ba7f2d5c381080c69ffe/9/7/9788417490324_lmskevq12j7c8eiw.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="product__sm-content">
                                        <h5 class="product__sm-title">
                                            <a href="{{ route ('home.product-details.index')}}">Classic Leather Backpack Daypack 2022</a>
                                        </h5>
                                ...
                                <li class="product__sm-item d-flex align-items-center">
                                    ...
                                    <div class="product__sm-content">
                                        <h5 class="product__sm-title">
                                            <a href="{{ route ('home.product-details.index')}}">Samsung Galaxy A12, 32GB, Black - (Locked)</a>
                                        </h5>
                                        <div class="product__sm-price">
                                ...
                                <li class="product__sm-item d-flex align-items-center">
                                    ...
                                    <div class="product__sm-content">
                                        <h5 class="product__sm-title">
                                            <a href="{{ route ('home.product-details.index')}}">Imported Wooden Felt Cushion Chair</a>
                                        </h5>
                                        <div class="product__sm-price">
                                ...
                                <li class="product__sm-item d-flex align-items-center">
                                    ...
                                    <div class="product__sm-content">
                                        <h5 class="product__sm-title">
                                            <a href="{{ route ('home.product-details.index')}}">Sunhouse Decorative Lights - Imported</a>
                                        </h5>
                                        <div class="product__sm-price">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="shop-banner mb-30">
                        <div class="banner-image">
                            <img class="banner-l" src="{{asset('assets/customer/img/banner/banner-shop.png')}}" alt="">
                            <img class="banner-sm" src="{{asset('assets/customer/img/banner/banner-shop-sm.png')}}" alt="">
                            <div class="banner-content text-center">
                                <p class="banner-text mb-30">Hurry Up! <br> Free Shipping All Order Over $99</p>
                                <a href="{{route('home.shop.index')}}" class="st-btn-d b-radius">Discover now</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                        <div class="product__item product__item-d">
                                            ...
                                            <div class="product__content-3">
                                                ...
                                                <h6><a href="{{ route ('home.product-details.index')}}">Boku No Hero Academy</a></h6>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="features-thum">
                                                            <div class="features-product-image w-img">
                                                                <a href="{{ route ('home.product-details.index')}}"><img src="https://www.crisol.com.pe/media/catalog/product/cache/cf84e6047db2ba7f2d5c381080c69ffe/9/7/9788417490324_lmskevq12j7c8eiw.jpg" alt=""></a>
                                                            </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="product__content product__content-d">
                                                            ...
                                                            <div class="features-des">
                                                                <ul>
                                                                    <li><a href="{{ route ('home.product-details.index')}}"><i class="fa fa-circle"></i> Bass and Stereo Sound.</a></li>
                                                                    <li><a href="{{ route ('home.product-details.index')}}"><i class="fa fa-circle"></i> Display with 3088 x 1440 pixels resolution.</a></li>
                                                                    <li><a href="{{ route ('home.product-details.index')}}"><i class="fa fa-circle"></i> Memory, Storage &amp; SIM: 12GB RAM, 256GB.</a></li>
                                                                    <li><a href="{{ route ('home.product-details.index')}}"><i class="fa fa-circle"></i> Androi v10.0 Operating system.</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product__modal-content">
                                ...
                                <div class="product__modal-des mt-20 mb-15">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-circle"></i> Bass and Stereo Sound.</a></li>
                                        <li><a href="#"><i class="fa fa-circle"></i> Display with 3088 x 1440 pixels resolution.</a></li>
                                        <li><a href="#"><i class="fa fa-circle"></i> Memory, Storage & SIM: 12GB RAM, 256GB.</a></li>
                                        <li><a href="#"><i class="fa fa-circle"></i> Androi v10.0 Operating system.</a></li>
                                    </ul>
                                </div>
