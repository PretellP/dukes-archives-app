                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="section__head d-flex justify-content-between mb-10">
                            ...
                            <div class="section__title">
                                <h5 class="st-titile" data-filter=".{{ str_replace(' ', '-', mb_strtolower($labels[0]->name ?? '', 'UTF-8')) }}">LIBROS DE {{ ucwords(mb_strtoupper($labels[0]->name ?? '', 'UTF-8')) }}</h5>
                            </div>
                            ...
                            <div class="swiper-wrapper img-carousel">
                                @foreach ($products as $product )
                                    @foreach ($product->labels as $label )
                                        @if ($label->id === 3)
                                        <div class="swiper-slide {{ implode(' ', ($product->labels->map(function ($label) { return str_replace(' ', '-', mb_strtolower($label->name ?? '', 'UTF-8')); })->toArray())) }}" >
                                            <div class="product__item">
                                                <div class="product__thumb fix">
                                                    <div class="product-image h-img w-img">
                                                        <a href="#">
                                                            <img src="{{ verifyImage($product->files->first()) }}" class="carousel-set" alt="product">
                                                        </a>
                                                    </div>                          
                                                    <div class="product-action">
                                                ...
                                                <div class="product__content">
                                                    <h6 class="product-category pt-2"><a href="#">{{ restrictMaxLengthText($product->labels->first()->description, 45) }}</a></h6>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="section__head d-flex justify-content-between mb-10">
                                ...
                                <div class="section__title">
                                    <h5 class="st-titile">LIBROS DE {{mb_strtoupper($labels[1]->name)}}</h5>
                                </div>
                    ...
                    <div class="product-bs-slider">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                @foreach ($products as $product)
                                    @foreach ($product->labels as $label)
                                        @if ($label->name === 'aventura')
                                            <div class="swiper-slide">
                                                <div class="product__item">
                                                    <div class="product__thumb fix">
                                                        <div class="product-image w-img h-img ">
                                                            <a href="#">
                                                                <img src="{{ verifyImage($product->files->first()) }}" alt="product">
                                                            </a>
                                                        </div>                          
                                                        <div class="product-action">
                                                            <a href="{{ route('home.product-details.index', $product) }}" class="icon-box icon-box-1">
