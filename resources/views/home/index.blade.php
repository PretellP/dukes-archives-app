...
@section('content')
    <main>
                    ...
                    @foreach ($banners as $banner)
                        @if ($loop->first)
                            <div class="single-slider swiper-slide slider-height">
                                <img class="imagencita" src="{{ verifyImage($banner->file) }}" alt="">
                            </div>
                        @else

                            <div class="single-slider swiper-slide slider-height d-flex align-items-center"
                                data-background="{{ verifyImage($banner->file) }}">
                            </div>
                        @endif
                    @endforeach
        ...
        <section class="features__area pt-20 mb-6">
            <div class="container">
        ...
        @foreach ($labels as $key => $label)
            <section class="recomand-product-area" data-key="{{ $key }}">
                <div class="contenedor">
                        ...
                        <div class="col-xl-12">
                            <div class="section__head d-flex justify-content-between mb-10">
                                <div class="section__title">
                                    <h5 class="st-titile">
                                        {{ mb_strtoupper($label->name, 'UTF-8') }}
                                    </h5>
                                </div>
                                <div class="button-wrap">
                                    <a href="{{ route('home.shop.index') }}">VER TODO <i
                    ...
                    <div class="row g-0">
                        <div class="product-bs-slider">
                            <div class="product-slider{{ $key }} product-slids swiper-container">
                                    ...
                                    @foreach ($label->products as $product)
                                        <div class="product__item swiper-slide">
                                            <div class="product__thumb fix">
                                                <div class="product__thumb fix">
                                                    <div class="product-image h-img w-img">
                                                        <a href="#">
                                                            <img src="{{ verifyImage($product->files->first()) }}"
                                                                class="carousel-set" alt="product">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-action">
                                                    <a href="{{ route('home.product-details.index', $product) }}"
                                                        class="icon-box icon-box-1">
                                                        <i class="fa fa-eye"></i>
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('home.wishlist.agregarProducto', $product) }}"
                                                        class="icon-box icon-box-1">
                                            ...
                                            <div class="product__content">
                                                <h6 class="product-category pt-2"><a
                                                        href="#">{{ restrictMaxLengthText($label->description, 45) }}</a>
                                                </h6>
                                                <h6 class="text-truncate"><a href="#">{{ $product->name }}</a></h6>
                                                <div class="price">
                            ...
                            <div class="bs-button bs{{ $key }}-button-prev"><i class="fa fa-chevron-left"></i>
                            </div>
                            <div class="bs-button bs{{ $key }}-button-next bs-button-next"><i
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="section__head d-flex justify-content-between mb-10">
                            ...
                            <div class="section__title">
                                <h5 class="st-titile"
                                    data-filter=".{{ str_replace(' ', '-', mb_strtolower($labels[0]->name ?? '', 'UTF-8')) }}">
                                    LIBROS DE {{ ucwords(mb_strtoupper($labels[0]->name ?? '', 'UTF-8')) }}</h5>
                            </div>
                ...
                <div class="row g-0">
                    <div class="product-bs-slider">
                        <div class="swiper-container">
                            <div class="swiper-wrapper img-carousel">
                                @foreach ($products as $product)
                                    @foreach ($product->labels as $label)
                                        @if ($label->id === 3)
                                            <div
                                                class="swiper-slide {{ implode(' ',$product->labels->map(function ($label) {return str_replace(' ', '-', mb_strtolower($label->name ?? '', 'UTF-8'));})->toArray()) }}">
                                                <div class="product__item">
                                                    ...
                                                    <div class="product__content">
                                                        <h6 class="product-category pt-2"><a
                                                                href="#">{{ restrictMaxLengthText($product->labels->first()->description, 45) }}</a>
                                                        </h6>
                                                    ...
                                                    <div class="product__add-cart text-center">
                                                        <a
                                                            href="{{ route('home.cart.agregarProducto', ['p' => $product]) }}">
                                                            <button type="button"
                                                                class="cart-btn product-modal-sidebar-open-btn d-flex align-items-center justify-content-center w-100 ">
                                                                Añadir al carrito
                                                            </button>
                            ...
                            <!-- If we need navigation buttons -->
                            <div class="bs-button bs3-button-prev"><i class="fa fa-chevron-left"></i></div>
                            <div class="bs-button bs3-button-next"><i class="fa fa-chevron-right"></i></div>
                        </div>
                    </div>
                </div>
