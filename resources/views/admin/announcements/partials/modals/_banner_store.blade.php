<div class="modal fade" id="registerBannerModal" tabindex="-1" aria-labelledby="registerBannerModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.announcements.store') }}" id="registerBannerForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="description" class="form-control content"
                    ...
                    <div class="form-row">
                        <label class="custom-switch">
                                ...
                                <span id="txt-status-banner" class="custom-switch-description txt-status-banner">Activo</span>
                        </label>
                    </div>
